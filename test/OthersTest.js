...
describe("Interpreter", function () {
    ...
    describe('Interpreter Facts', function () {
        ...
        it('add(two, two, one). should be true', function () {
            assert(interpreter.checkQuery('add(two, two, one)'));
        });

        it('add(two, two, one). should be false', function () {
            assert(interpreter.checkQuery('add(two, two, one)') === true);
        });
    ...
    describe('Interpreter Rules', function () {
        ...
        it('subtract(one, one, two) should be true', function () {
